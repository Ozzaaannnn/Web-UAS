    ...
    },
    {
        ...
        const storeMenuData = {
            ...
            stores: [
                { label: "Steam", link: "https://store.steampowered.com/" },
                { label: "Epic Games", link: "https://store.epicgames.com/en-US" },
                { label: "PS Store", link: "https://store.playstation.com/en-id/pages/latest" },
                { label: "GOG.com", link: "https://www.gog.com/en/" }
            ]
        };
        ...
        const gamesData = {
            ...
            "fighting": [
                ...
                { id: 2, title: "Street Fighter 6", src: "Street Fighter.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/HP0102-PPSA02635_00-SF600000STANDARD" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1364780/Street_Fighter_6/" },
                        ]},
                { id: 3, title: "Mortal Kombat 1", src: "Mortal Kombat.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/UP1018-PPSA07570_00-MKONE00000000000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1971870/Mortal_Kombat_1/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/mortal-kombat-1" }
                        ]},
                { id: 4, title: "Guilty Gear Strive", src: "Guilty Gear.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/EP0700-PPSA02257_00-GGSTPS5EU0000100" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1384160/GUILTY_GEAR_STRIVE/" },
                        ]},
                { id: 5, title: "Super Smash Bros Ultimate", src: "Super Smash Bros.png",
                    popupLinks:[
                        { label: "Nintendo Switch", url: "https://smashbros.nintendo.com/buy/" }
                        ]},
                { id: 6, title: "Dragon Ball FighterZ", src: "Dragon Ball FighterZ.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/EP0700-PPSA09789_00-ASIAPLACEHOLDER1" },
                        { label: "Steam", url: "https://store.playstation.com/en-id/product/EP0700-PPSA09789_00-ASIAPLACEHOLDER1" }
                        ]},
                { id: 7, title: "MultiVersus", src: "Multiversus.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://www.playstation.com/en-id/games/multiversus/" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1818750/MultiVersus/" },
                        ]},
                { id: 8, title: "Injustice 2.", src: "Injustice.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/UP1018-CUSA05462_00-ASIA000000000000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/627270/Injustice_2/" },
                        ]},
            ],
            "horror": [
                { id: 1, src: "Silent Hill F.png", title: "Silent Hill f",
                ...
                { id: 2, title: "MiSide", src: "Miside.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/2527500/MiSide/" }
                        ]},
                { id: 3, title: "Resident Evil 4", src: "Resident Evil.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/HP0102-PPSA09418_00-RE4RMAINGAME0000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/2050650/Resident_Evil_4/" }
                        ]},
                { id: 4, title: "Alan Wake II", src: "Alan Wake.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/UP1477-PPSA02571_00-ALANWAKE20000000" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/alan-wake-2" }
                        ]},
                { id: 5, title: "Phasmophobia", src: "Phasmaphobia.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/739630/Phasmophobia/" }
                        ]},
                { id: 6, title: "Lethal Company", src: "Lethal Company.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/1966720/Lethal_Company/" }
                        ]},
                { id: 7, title: "Madison", src: "Madison.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/HP3536-CUSA33919_00-9387755703541772" },
                        { label: "GOG", url: "https://www.gog.com/en/game/madison" }
                        ]},
                { id: 8, title: "Little Nightmares III", src: "Little Nightmares.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/EP0700-PPSA05143_00-LITTLENIGHTS3000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1392860/Little_Nightmares_III/" }
                        ]},
            ],
            "simulation": [
                { id: 1, title: "Microsoft Flight Simulator 2024", src: "MFS.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/UP6312-PPSA23943_00-FLIGHTSIM2024STA" },
                        { label: "Steam", url: "https://store.steampowered.com/app/2537590/Microsoft_Flight_Simulator_2024/" }
                        ]},
                { id: 2, title: "Cities Skylines II", src: "Cities Skylines.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/949230/Cities_Skylines_II/" }
                        ]},
                { id: 3, title: "Farming Simulator 25", src: "Farming Simulator.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/EP4399-PPSA19644_00-FARMSIMULAT25PS5" },
                        { label: "Steam", url: "https://store.steampowered.com/app/2300320/Farming_Simulator_25/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/farming-simulator-25-917e48" }
                        ]},
                { id: 4, title: "Euro Truck Simulator 2", src: "Euro Truck Simulator.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/227300/Euro_Truck_Simulator_2/" }
                        ]},
                { id: 5, title: "Stardew Valley", src: "Stardew Valley.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/413150/Stardew_Valley/" },
                        { label: "GOG", url: "https://www.gog.com/en/game/stardew_valley" }
                        ]},
                { id: 6, title: "PC Building Simulator 2", src: "Pc Building Simulator.png",
                    popupLinks:[
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/pc-building-simulator-2" }
                        ]},
                { id: 7, title: "inZOI", src: "InZOI.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/2456740/inZOI/" }
                        ]},
                { id: 8, title: "Goat Simulator 3", src: "Goat Simulator.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/EP4837-PPSA04158_00-GS3MAINGAMEPACK0" },
                        { label: "Steam", url: "https://store.steampowered.com/app/850190/Goat_Simulator_3/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/goat-simulator-3" }
                        ]},
            ],
            "story": [
                { id: 1, src: "Silent Hill F.png", title: "Silent Hill f",
                ...
                { id: 4, title: "Omori", src: "Omori.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/1150690/OMORI/" }
                        ]},
                ...
                { id: 7, title: "A Space for the Unbound", src: "A Space for the Unbound.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/JP0211-CUSA35793_00-3635252122584103" },
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/JP0211-PPSA09501_00-6534109074226497" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1201270/A_Space_for_the_Unbound/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/a-space-for-the-unbound-57e666" },
                        { label: "GOG", url: "https://www.gog.com/en/game/a_space_for_the_unbound" }
                        ]},
                { id: 8, title: "Undertale", src: "Undertale.png",
                    popupLinks:[
                        { label: "Steam", url: "https://store.steampowered.com/app/391540/Undertale/" },
                        { label: "GOG", url: "https://www.gog.com/en/game/undertale" }
                        ]},
            ],
            "sports": [
                { id: 1, title: "Forza Horizon", src: "Forza Horizon.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/UP6312-PPSA22327_00-0547256477986893" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1551360/Forza_Horizon_5/" }
                        ]},
                { id: 2, title: "EAFC", src: "FC26.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/UP0006-PPSA27360_00-FC26FCLIVEBUNDLE" },
                        { label: "Steam", url: "https://store.steampowered.com/app/3405690/EA_SPORTS_FC_26/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/ea-sports-fc-26" }
                        ]},
                { id: 3, title: "NBA2K", src: "NBA2K.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/UP1001-PPSA28420_00-NBA2K26000000000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/3472040/NBA_2K26/" }
                        ]},
                { id: 4, title: "F125", src: "F1 25.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/UP0006-PPSA24662_00-F12025PS5GAME000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/3059520/F1_25/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/f1-25-0729b0" }
                        ]},
                { id: 5, title: "TopSpin", src: "TopSpin.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/UP1001-PPSA06898_00-TS2K25CROSSGENED" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1785650/TopSpin_2K25/" }
                        ]},
                { id: 6, title: "Assetto Corsa", src: "Assetto Corsa.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/EP4040-CUSA01797_00-ASIAASSETTOCORSA" },
                        { label: "Steam", url: "https://store.steampowered.com/app/244210/Assetto_Corsa/" }
                        ]},
                { id: 7, title: "Gran Turismo 7", src: "Gran Turismo.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/HP9000-PPSA01318_00-GT7STD0000000PS5" }
                        ]},
                { id: 8, title: "MotoGP", src: "MotoGP.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/EP4356-CUSA53165_00-MOTOGP25FULLGAME" },
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/EP4356-PPSA25319_00-MOTOGP25FULLGAME" },
                        { label: "Steam", url: "https://store.steampowered.com/app/3077390/MotoGP25/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/motogp25-12906a" }
                        ]},
            ],
            "adventure": [
                { id: 1, title: "Minecraft Dungeons", src: "Minecraft Dungeons.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/JP0127-CUSA18811_00-DUNGEONSPS400000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1672970/Minecraft_Dungeons/" }
                        ]},
                { id: 2, title: "Horizon Zero Dawn", src: "Horizon Zero Dawn.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/UP9000-PPSA13428_00-HORIZONREMASTERA" },
                        { label: "Steam", url: "https://store.steampowered.com/app/2561580/Horizon_Zero_Dawn_Remastered/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/horizon-zero-dawn-remastered" }
                        ]},
                { id: 3, title: "The Witcher 3", src: "The Witcher.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/HP4497-PPSA10412_00-00000000000000N6" },
                        { label: "Steam", url: "https://store.steampowered.com/app/292030/The_Witcher_3_Wild_Hunt/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/the-witcher-3-wild-hunt" },
                        { label: "GOG", url: "https://www.gog.com/en/game/the_witcher_3_wild_hunt" }
                        ]},
                { id: 4, title: "Uncharted", src: "Uncharted.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/HP9000-CUSA00912_00-ASIAPLACEHOLDER0" }
                        ]},
                { id: 5, title: "FarCry 6", src: "Far Cry 6.png",
                    popupLinks:[
                        { label: "PlayStation 4&5", url: "https://store.playstation.com/en-id/product/JP0001-PPSA01877_00-FC6EDSTANDARD000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/2369390/Far_Cry_6/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/far-cry-6" }
                        ]},
                { id: 6, title: "Shadow of the Tomb Raider", src: "Shadow of the Tomb Raider.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/UP0082-CUSA10938_00-SHADOWTOMBRAIDER" },
                        { label: "Steam", url: "https://store.steampowered.com/app/750920/Shadow_of_the_Tomb_Raider_Definitive_Edition/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/shadow-of-the-tomb-raider" },
                        { label: "GOG", url: "https://www.gog.com/en/game/shadow_of_the_tomb_raider_definitive_edition" }
                        ]},
                { id: 7, title: "Red Dead Redemption 2", src: "Red Dead Redemption.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/UP1004-CUSA03041_00-REDEMPTIONFULL02" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1174180/Red_Dead_Redemption_2/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/red-dead-redemption-2" }
                        ]},
                { id: 8, title: "Assassin's Creed Shadows", src: "Assassin's Creed Shadows.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/JP0001-PPSA20398_00-GAME000000000000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/3159330/Assassins_Creed_Shadows/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/assassins-creed-shadows" }
                        ]},
            ],
            "racing": [
                { id: 1, title: "Forza Horizon", src: "Forza Horizon.png",
                ...
                { id: 5, title: "MotoGP", src: "MotoGP.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/EP4356-CUSA53165_00-MOTOGP25FULLGAME" },
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/EP4356-PPSA25319_00-MOTOGP25FULLGAME" },
                        { label: "Steam", url: "https://store.steampowered.com/app/3077390/MotoGP25/" },
                ...
                { id: 6, title: "The Crew 2", src: "The Crew.png",
                    popupLinks:[
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/EP0001-CUSA08609_00-ASIAFULLGAMESTED" },
                        { label: "Steam", url: "https://store.steampowered.com/app/646910/The_Crew_2/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/the-crew-2" }
                        ]},
                { id: 7, title: "WRC 10", src: "WRC.png",
                    popupLinks:[
                        { label: "PlayStation 5", url: "https://store.playstation.com/en-id/product/EP6665-CUSA27790_00-WRC1000000000000" },
                        { label: "PlayStation 4", url: "https://store.playstation.com/en-id/product/EP6665-PPSA03589_00-WRC1000000000000" },
                        { label: "Steam", url: "https://store.steampowered.com/app/1462810/WRC_10_FIA_World_Rally_Championship/" },
                        { label: "Epic Games", url: "https://store.epicgames.com/en-US/p/wrc-10" }
                        ]},
                        ...
                        ${storeMenuData.stores.map(store => `
                            <li>
                                <a
                                    ...
                                    class="hover:text-[#1832a3] hover:underline transition"
                                >
                                    ${store.label}
                                </a>
                            </li>
